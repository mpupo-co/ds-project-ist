...
def feature_selection(dfs: list[DataFrame], strategy: str, target: str, 
                      min_threshold: float = 0.4, max_threshold: float = 0.45) -> tuple[DataFrame, DataFrame]:
    ...
    train, test = apply_feature_selection(train, test, vars2drop)
