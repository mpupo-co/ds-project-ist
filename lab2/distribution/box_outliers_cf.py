...
#     data[numeric].boxplot(rot=45, ax=ax, whis=2.5)
#     tight_layout()
#     savefig(f"images/{file_tag}_global_boxplot_2.5.png")
# else:
...
#         axs[i, j].boxplot(data[numeric[n]].dropna().values, whis=2.5)
#         i, j = (i + 1, 0) if (n + 1) % cols == 0 else (i, j + 1)
#     savefig(f"images/{file_tag}_single_boxplots_2.5.png")
# else:
#     print("There are no numeric variables.")
...
if [] != numeric:
    outliers = count_outliers(data, numeric, nrstdev=3, iqrfactor=2.5)
