...
from services.traffic_accidents.encoding import data_encoding
from services.traffic_accidents.outliers import get_variable_types, process_outliers
from services.traffic_accidents.balancing import data_balancing
from services.traffic_accidents.feature import feature_selection
import time
...
class DataPipeline:
    ...
    def fit(self, df: DataFrame) -> DataFrame:
        ...
        df_prepared.to_csv("data/processed_ta.csv", index=False)
        self.fitted = True
        return df_prepared
